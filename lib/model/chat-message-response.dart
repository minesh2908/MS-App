...
class ChatMessageResponse {
    ...
    factory ChatMessageResponse.fromJson(String str) => ChatMessageResponse.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory ChatMessageResponse.fromMap(Map<String, dynamic> json) => ChatMessageResponse(
        candidates: json["candidates"] == null ? [] : List<Candidate>.from(json["candidates"]!.map((x) => Candidate.fromMap(x))),
        promptFeedback: json["promptFeedback"] == null ? null : PromptFeedback.fromMap(json["promptFeedback"]),
    );

    Map<String, dynamic> toMap() => {
        "candidates": candidates == null ? [] : List<dynamic>.from(candidates!.map((x) => x.toMap())),
...
class Candidate {
    ...
    factory Candidate.fromMap(Map<String, dynamic> json) => Candidate(
        ...
        index: json["index"],
        safetyRatings: json["safetyRatings"] == null ? [] : List<SafetyRating>.from(json["safetyRatings"]!.map((x) => SafetyRating.fromMap(x))),
    );
    ...
    Map<String, dynamic> toMap() => {
        ...
        "index": index,
        "safetyRatings": safetyRatings == null ? [] : List<dynamic>.from(safetyRatings!.map((x) => x.toMap())),
    };
}
...
class Content {
    ...
    factory Content.fromMap(Map<String, dynamic> json) => Content(
        parts: json["parts"] == null ? [] : List<Part>.from(json["parts"]!.map((x) => Part.fromMap(x))),
        role: json["role"],
    );
...
class SafetyRating {
    ...
    factory SafetyRating.fromJson(String str) => SafetyRating.fromMap(json.decode(str));
...
class PromptFeedback {
    ...
    factory PromptFeedback.fromJson(String str) => PromptFeedback.fromMap(json.decode(str));
