...
class mobileScreenDeveloper extends StatefulWidget {
  const mobileScreenDeveloper({
    super.key,
  });

  @override
  State<mobileScreenDeveloper> createState() => _mobileScreenDeveloperState();
}

class _mobileScreenDeveloperState extends State<mobileScreenDeveloper> {
  @override
                    ...
                    Expanded(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Heading(title: 'Project Engineer, Wipro'),
                            SubHeading(subHeading: 'Sep 2022 - Present'),
                            SizedBox(
                              height: 10,
                            ),
                            DetailPoint(
                    ...
                    Expanded(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Heading(title: 'Development Intern, PN Infosys'),
                            SubHeading(subHeading: 'Mar 2019 - July 2019'),
                            SizedBox(
                              height: 10,
                            ),
                            DetailPoint(
                      ...
                      child: Column(
                        children: [
                          CircleAvatar(
                            ...
                            backgroundColor: Colors.transparent,
                            child:
                                Image(image: AssetImage('assets/tmt_logo.png')),
                          ),
                        ],
                      ),
                    ),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SubHeading(subHeading: 'May 2018 - May 2022'),
                            SizedBox(
                              height: 10,
                            ),
                            Text(
                    ...
                    Expanded(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Heading(title: 'Habit Flag Beared'),
                            SubHeading(
                              subHeading: 'Wipro',
                            ),
                            SizedBox(
